...
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#ES2018_revision_of_illegal_escape_sequences`;
  ...
  margin: 1% 10%;
`;
  var Text = emotion_styled_browser_esm_default.div`
  padding: 10px 30% 10px 3%;
`;
  var TextRight = emotion_styled_browser_esm_default(Text)`
  text-align: right;
  font-weight: bold;
  padding: 10px 3% 10px 30%;
`;
  var Discussion = () => {
    return /* @__PURE__ */ React2.createElement(Wrapper, null, /* @__PURE__ */ React2.createElement(Text, null, `> \u201CWhat do you have to show for?"`), /* @__PURE__ */ React2.createElement(TextRight, null, `"Nothing, almost nothing." <<`), /* @__PURE__ */ React2.createElement(Text, null, `> \u201CYou are inventing work. You are avoiding of doing the work.\u201D`));
  };
  ReactDOM.render(
    React2.createElement(Discussion, null),
