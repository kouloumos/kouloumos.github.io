...
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#ES2018_revision_of_illegal_escape_sequences`;
  ...
  // <stdin>
  var IntroWrapper = emotion_styled_browser_esm_default.div`
  font-size: 12px;
  font-style: italic;
  padding-bottom: 7px;
...
`;
  var Intro = () => {
    ...
    return /* @__PURE__ */ React2.createElement(IntroWrapper, null, /* @__PURE__ */ React2.createElement("span", null, `This is ${number != " " ? `the ${number}` : ""} part of my `), /* @__PURE__ */ React2.createElement("a", { href: "/getting-to-base-camp" }, '"Getting to Base Camp"'), " ", /* @__PURE__ */ React2.createElement("span", null, `series; a reflection of my first year as an aspiring Bitcoin Core contributor and a call to other bystanders.`));
  };
  ReactDOM.render(
    React2.createElement(Intro, null),
