        ...
        (function() {
          ...
          function getNearestMountedFiber(fiber) {
            ...
            if (!fiber.alternate) {
              ...
              do {
                node2 = nextNode;
                if ((node2.effectTag & (Placement | Hydrating)) !== NoEffect) {
          ...
          function hideOrUnhideAllChildren(finishedWork, isHidden) {
            {
              ...
              while (true) {
                ...
                } else if (node2.tag === SuspenseComponent && node2.memoizedState !== null && node2.memoizedState.dehydrated === null) {
          ...
          function commitNestedUnmounts(finishedRoot, root2, renderPriorityLevel) {
            ...
            while (true) {
              ...
              if (node2.child !== null && // If we use mutation we drill down into portals using commitUnmount above.
          ...
          function markUpdateTimeFromFiberToRoot(fiber, expirationTime) {
            ...
            var root2 = null;
            if (node2 === null && fiber.tag === HostRoot) {
              root2 = fiber.stateNode;
            } else {
              while (node2 !== null) {
                alternate = node2.alternate;
                if (node2.childExpirationTime < expirationTime) {
                ...
                if (node2.return === null && node2.tag === HostRoot) {
...
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#ES2018_revision_of_illegal_escape_sequences`;
  ...
  // <stdin>
  var SpoilerWrapper = emotion_styled_browser_esm_default.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  padding: 14%;
`;
  var SpoilerText = emotion_styled_browser_esm_default.div`
  font-size: 24px;
  font-style: bold;
`;
  var TwitterCTA = emotion_styled_browser_esm_default.a`
  align-self: flex-end;
`;
  var twitterRef = "https://twitter.com/messages/compose?recipient_id=1074061591";
  var Spoiler = () => {
    const [text, setText] = React2.useState("");
    const [twitterCTA, setTwitterCTA] = React2.useState("");
    const [twitterDM, setTwitterDM] = React2.useState("");
    React2.useEffect(() => {
    ...
    return /* @__PURE__ */ React2.createElement(SpoilerWrapper, null, /* @__PURE__ */ React2.createElement(SpoilerText, null, text), /* @__PURE__ */ React2.createElement(TwitterCTA, { href: `${twitterRef}&text=${twitterDM}`, target: "_blank" }, twitterCTA));
  };
  ReactDOM.render(
    React2.createElement(Spoiler, null),
